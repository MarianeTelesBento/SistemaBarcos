...
namespace SistemaBarcos.UI.Models
{
    public class Cadastro : Validacao
    {
        ...
        {
            string connectionString = "Data Source=DESKTOP-B2J8C6H\\SQLEXPRESS;Initial Catalog=M34Dd;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False";
            /*Chave senac: Data Source=FAC0539673W10-1;Initial Catalog=M34Db;User ID=sa;Password=123456;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False*/
